...
use frontend\assets\SetupAsset;
                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                ...
                                <li class="nav-item"><a href="../../../../layout_2/LTR/dark/full/index.html"
                                        class="nav-link">Layout 2</a></li>
                                <li class="nav-item"><a href="../../../../layout_3/LTR/dark/full/index.html"
                                        class="nav-link">Layout 3</a></li>
                                <li class="nav-item"><a href="../../../../layout_4/LTR/dark/full/index.html"
                                        class="nav-link">Layout 4</a></li>
                                <li class="nav-item"><a href="../../../../layout_5/LTR/dark/full/index.html"
                                        class="nav-link">Layout 5</a></li>
                                <li class="nav-item"><a href="../../../../layout_6/LTR/dark/full/index.html"
                                ...
                                <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                                    ...
                                    <ul class="nav nav-group-sub">
                                        ...
                                        <li class="nav-item"><a href="sidebar_default_hidden.html"
                                                class="nav-link active">Default hidden</a></li>
                                        ...
                                        <li class="nav-item"><a href="sidebar_mini_hidden.html" class="nav-link">Mini
                                                hidden</a></li>
                                        <li class="nav-item-divider"></li>
                                        <li class="nav-item"><a href="sidebar_default_color_dark.html"
            ...
            <div class="page-header border-bottom-0">
                <div class="page-header-content header-elements-md-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">WEB SCHOOL </span>
                            -
                            Initial Setup</h4>
