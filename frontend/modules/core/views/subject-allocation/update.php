...
$this->title = 'Update Subject Allocation: ' . $model->subjectallocation_id;
$this->params['breadcrumbs'][] = ['label' => 'Subject Allocations', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->subjectallocation_id, 'url' => ['view', 'id' => $model->subjectallocation_id]];
