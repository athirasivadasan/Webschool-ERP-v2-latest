...
$this->title = 'Update Student Category: ' . $model->studentcategory_name;
$this->params['breadcrumbs'][] = ['label' => 'Student Categories', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->studentcategory_id, 'url' => ['view', 'id' => $model->studentcategory_id]];
    ...
    <div class="d-flex">
        <div class="breadcrumb">
            <a href="<?=Yii::$app->request->baseUrl;?>" class="breadcrumb-item"><i class="icon-home2 mr-2"></i>
                <?=Yii::t('app', 'Home');?></a>
            <a href="<?php echo Url::to(['student-category/create']); ?>" class="breadcrumb-item"><?=Yii::t('app', 'Student');?></a>
            
            <span class="breadcrumb-item active"><?=Yii::t('app', 'Student Category');?></span>
        </div>
...
'model' => $model,'dataProvider' => $dataProvider
    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title"><?=Yii::t('app', 'Student Category');?></h5>
                <div class="header-elements">
                    <div class="list-icons">
                        <!-- <a class="list-icons-item" data-action="collapse"></a>
                        <a class="list-icons-item" data-action="reload"></a>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'urlCreator' => function ($action, $model, $key, $index) {
                                    if ($action === 'update') {
                                        $url = Url::to(['student-category/update', 'id' => $model->slug]);
                                        return $url;
                                    }
                                    if ($action === 'delete') {
                                        $url = Url::to(['student-category/delete', 'id' => $model->slug]);
                                        return $url;
                                    }
