...
$this->title = 'Create Student Caste';
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-highlight">
                        <li class="nav-item">
                            <a href="<?php echo Url::to(['student-caste/create']); ?>" class="nav-link active" >Student Caste</a>
                        </li>

                        <li class="nav-item">
                            <a href="<?php echo Url::to(['student-religion/create']); ?>" class="nav-link">Student Religion</a>
                        </li>
