...
$this->title = 'Update Student Caste: ' . $model->studentcasteid;
$this->params['breadcrumbs'][] = ['label' => 'Student Castes', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->studentcasteid, 'url' => ['view', 'id' => $model->studentcasteid]];
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-highlight">
                    <li class="nav-item">
                        <a href="#icon-only-tab1" class="nav-link active" data-toggle="tab">Student Caste</a>
                    </li>

                    <li class="nav-item">
                        <a href="#icon-only-tab2" class="nav-link" data-toggle="tab">Student Religion</a>
                    </li>
                                            ...
                                            'columns' => [
                                                ...
                                                [
                                                    ...
                                                    'urlCreator' => function ($action, $model, $key, $index) {
                                                        if ($action === 'update') {
                                                            $url = Url::to(['student-caste/update', 'id' => $model->slug]);
                                                            return $url;
                                                        }
                                                        if ($action === 'delete') {
                                                            $url = Url::to(['student-caste/delete', 'id' => $model->slug]);
                                                            return $url;
                                                        }
