...
<div
    ...
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <a href="<?php echo Url::to(['department/create']); ?>" class="breadcrumb-item"><?=Yii::t('app', 'Department');?></a>
            <span class="breadcrumb-item active"><?=Yii::t('app', 'Update Department');?></span>
        </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title"><?=Yii::t('app', 'Update Department');?></h5>
                <div class="header-elements">
                    <div class="list-icons">
                        <!-- <a class="list-icons-item" data-action="collapse"></a>
                        <a class="list-icons-item" data-action="reload"></a>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'urlCreator' => function ($action, $model, $key, $index) {
                                ...
                                if ($action === 'update') {
                                    $url = Url::to(['department/update', 'id' => $model->slug]);
                                    return $url;
                                }
                                if ($action === 'delete') {
                                    $url = Url::to(['department/delete', 'id' => $model->slug]);
                                    return $url;
                                }
